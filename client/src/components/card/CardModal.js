...
import { editCard, archiveCard } from '../../redux/actions/board';
    ...
    <Modal open={open} onClose={() => setOpen(false)}>
      <div className={`${classes.paper} ${classes.cardModal}`}>
        ...
        <div className={classes.modalSection}>
          ...
          <div>
            <h3 className={classes.labelTitle}>Color</h3>
            <GithubPicker
        ...
        <Checklist card={card} />
        <div className={classes.modalSection}>
          <div className={classes.modalBottomRight} style={{justifyItems: 'flex-end'}}>
